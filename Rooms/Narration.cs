        ...
        internal override void ReceiveChoice(string choice)
        {
            switch (choice)
            {
                case "suite":
                    ...
                    Console.WriteLine("Inconnu: Pardonnez mon enthousiasme, cela fait des lustres que j'habite ces ténébres sans la moindre" +
                    ...
                    Console.WriteLine("Kingsley: Cela est très bizarre que nous sommes les deux seuls personnes à être présent dans cette endroit." +
                        "Avez vous le moindre souvenir de comment vous aurez pu atterir ici?");
